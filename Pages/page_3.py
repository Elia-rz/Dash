...
image_paths2 = [
    "/assets/Main/Main_95.png",
    "/assets/Main/Main_58.png",
    "/assets/Main/Main_14.png",
    "/assets/Main/Main_101.png",
    "/assets/Main/Main_68.png",
    "/assets/Main/Main_17.png",
    "/assets/Main/Main_56.png",
    "/assets/Main/Main_94.png",
...
def save_data_to_csv(submit_clicks,code,q1,q2,q3,q4,q5,q6,q7):
    if submit_clicks > 0:
        ...
        with open(filename, 'w', newline='') as csvfile:
            ...
            combined_data2 = [[participant_code] + row for row in data_list2]
            writer.writerows(combined_data2)
        ...
        with open(filename1, 'w', newline='') as csvfile:
            ...
            combined_data2_2 = [[participant_code] + row for row in survey2]
            writer.writerows(combined_data2_2)
